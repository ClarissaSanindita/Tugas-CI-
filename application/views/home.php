        ...
        <div class="row">
              ...
              <div class="panel-body">
                <ul class="list-unstyled todo-list">
                  <li>
                    ...
                    <p>
                      <span class="title">Tugas Pak Arifin</span>
                      <span class="short-description">Lanjutan CI (tamplate)</span>
                  ...
                  <li>
                    ...
                    <p>
                      <span class="title">Tugas Pak Budi</span>
                      <span class="short-description">Membuat stiker dengan gambar sesuai contoh.</span>
                  ...
                  <li>
                    ...
                    <p>
                      <strong>Forum Mingguan OSIS</strong>
                      <span class="short-description">Membahas tentang program kerja periode 2018/2019</span>
          ...
          <div class="col-md-5">
            ...
            <div class="panel panel-scrolling">
              <div class="panel-heading">
                <h3 class="panel-title">My Chat</h3>
                <div class="right">
                  <button type="button" class="btn-toggle-collapse"><i class="lnr lnr-chevron-up"></i></button>
                  <button type="button" class="btn-remove"><i class="lnr lnr-cross"></i></button>
                </div>
              ...
              <div class="panel-body">
                <ul class="list-unstyled activity-list">
                  <li>
                    ...
                    <p><a href="#">Ahmad Al Ghazali</a> Halo cha, apa kabar? <span class="timestamp">20 minutes ago</span></p>
                  </li>
                  <li>
                    <img src="assets/img/user2.png" alt="Avatar" class="img-circle pull-left avatar">
                    <p><a href="#">Daniel</a> Cha, tugas e ya apa i?  <span class="timestamp">Yesterday</span></p>
                  </li>
                  <li>
                    <img src="assets/img/user3.png" alt="Avatar" class="img-circle pull-left avatar">
                    <p><a href="#">Mbo ga Kenal</a> Ayooo MAINNNN!!! <span class="timestamp">2 days ago</span></p>
                  </li>
                  <li>
                    <img src="assets/img/user4.png" alt="Avatar" class="img-circle pull-left avatar">
                    <p><a href="#">Jane Bego</a> CHA ICHA <span class="timestamp">2 days ago</span></p>
                  </li>
                  <li>
                    <img src="assets/img/user5.png" alt="Avatar" class="img-circle pull-left avatar">
                    <p><a href="#">Jemi Jelek</a> Udah makan a? <span class="timestamp">3 days ago</span></p>
                  </li>
                </ul>
